...
把一份原始语料变成可长期复用的内容资产：先转录/整理进 Obsidian，再拆成金句、观点、方法论、小红书、朋友圈、口播和公众号素材。
...
这个 Skill 可以把小宇宙播客链接、播客逐字稿、访谈、会议纪要、读书笔记和临时想法，整理成可复用内容资产，并按需生成小红书、朋友圈、口播、公众号、金句库、观点库和方法论卡片。

请你先阅读仓库说明，帮我完成安装；如果涉及 Obsidian Vault 路径、知识库目录结构、常用平台、内容风格、播客来源、转写 API key 等信息，你需要先向我提问，不要擅自写死路径或泄露账号信息。

安装后，请根据我的实际目录结构，协助我把输出位置、播客素材目录、内容资产目录、小红书/朋友圈/口播输出规则调整成适合我长期复用的版本。
